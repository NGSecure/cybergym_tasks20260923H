...
> **This repo (cybergym_tasks20260923H).** The prime bundles live under
> `cybergym_tasks20260923H/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923H/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923H
# one bundle
